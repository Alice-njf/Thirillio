...
public class Book extends Bookmark implements Shareable{
	...
	public String toString() { 
		return "Book [id=" + getId() + ", title=" + getTitle() + ", profileUrl=" + getProfileUrl() +
		", publicationYear=" + publicationYear + ", publisher=" + publisher + ", authors="
				+ Arrays.toString(authors) + ", genre=" + genre + ", amazonRating=" + amazonRating + "]";
	}

	@Override
	public boolean isKidfriendlyEligible() {
		if(getTitle().contains("self_help") || getTitle().contains("Horror") || genre.contains(BookGenre.PHILOSOPHY)) {
			return false;
		}
		return true;
	}
